...
test_that("test changing the number line", {
  ...
  expect_equal(sort(c(number_line(5,7), number_line(2,10))), number_line(c(2,5),c(10,7), id =c(1L, 1L), gid =c(1L, 1L)))
  expect_equal(sort(c(number_line(5,7), number_line(2,10)), decreasing = TRUE), rev(number_line(c(2,5),c(10,7), id =c(1L, 1L), gid =c(1L, 1L))))
